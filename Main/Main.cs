...
public partial class Main : Node
{
    ...
    public override void _Ready()
    {
        ...
        camera1 = GetNode<Camera2d>("Viewports/ViewportContainer1/Viewport1/Camera2D1");
        camera2 = GetNode<Camera2d>("Viewports/ViewportContainer2/Viewport2/Camera2D2");
        ...
        camera1.SetTarget(world.GetNode<Node2D>("Player1"));
        camera2.SetTarget(world.GetNode<Node2D>("Player2"));
    }
